...
CATEGORY_DATA = {
    ...
    "Downhill (DH)": {"travel": 200, "stroke": 75.0, "base_sag": 35, "progression": 28, "lr_start": 3.28, "desc": "180–210 mm", "bike_mass_def_kg": 17.5, "bias": 72}
}
...
if raw_rate > 0:
    ...
    def generate_pdf():
        ...
        pdf.multi_cell(0, 5, "Engineering Disclaimer: Baseline derived from mass properties. Physical verification mandatory.")
